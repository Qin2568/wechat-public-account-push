...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxc8ee3abbcb6c6966',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'd6cc7e0855dda2b89f7d78c05e477424',
  ...
  USERS: [
    {
      ...
      id: 'oKhz556woCCMq2NtSveXMEkyIeFE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'z6xtU4bLsHiU-Cr0NS699Itg1nnaWqEgn6ZdIdw-jwA',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
